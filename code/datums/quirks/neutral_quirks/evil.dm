/datum/quirk/evil
	...
	desc = "Anyone who stares too long into your cold, uncaring eyes will know the truth. You are truly evil. \
		 There is nothing wrong with you, you wanted this."
	icon = FA_ICON_HAND_MIDDLE_FINGER
	value = 0
	mob_trait = TRAIT_EVIL
	gain_text = span_notice("You shed what remains of your humanity. You have work to do.")
