...
// /datum/loadout_item/suit/med_guard_jacket_light //CRANK EDIT - we don't got no dept. guards
...
/datum/loadout_item/suit/sec_jacket
	...
	restricted_roles = list (JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY)
...
/datum/loadout_item/suit/service_jacket
	...
	restricted_roles = list (JOB_JANITOR, JOB_BOTANIST, JOB_COOK, JOB_CHEF, JOB_BARBER, JOB_BARTENDER, JOB_CHAPLAIN, JOB_CURATOR, JOB_LAWYER, JOB_PSYCHOLOGIST, JOB_HEAD_OF_PERSONNEL)
