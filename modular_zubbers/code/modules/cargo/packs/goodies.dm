...
/datum/supply_pack/goody/wt550_single
	...
	cost = PAYCHECK_COMMAND * 23.5 //Nvm these are stronger than lasers in most scenarios so let's get them a bit of an edge. Plus gun price variety looks better
	access_view = ACCESS_WEAPONS
...
/datum/supply_pack/goody/wt550_ammo
	...
	cost = PAYCHECK_COMMAND * 6.5 //Scale it like all guns
...
/datum/supply_pack/goody/nt_shotgun
	...
	cost = PAYCHECK_COMMAND * 20 //Worse renoster, let's make it a tad cheaper
	access_view = ACCESS_WEAPONS
...
/datum/supply_pack/goody/renoster_shotgun
	...
	access_view = ACCESS_WEAPONS
	cost = PAYCHECK_COMMAND * 20 //I'd say it's at odds with the combat shotgun, sustain vs burst and such, but since ss13 favours burst I'll make it a tad cheaper.

/datum/supply_pack/goody/double_barrel
	cost = PAYCHECK_COMMAND * 15 //1400 is too much considering the combat shotgun is 1500 for 1
	access_view = ACCESS_WEAPONS
