/obj/item/gun/ballistic/automatic/pistol/sec_glock
	...
	desc = "This 9mm monster was developed during the very first body-modding craze by Nanotrasen. Built with every what-if in mind, this timeless brick is near-incapable of failure."
...
// 				return
// 	default_behaviour(user) //CRANK EDIT - spin larm
